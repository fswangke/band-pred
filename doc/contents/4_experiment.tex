...
over raw sequences, we actually transformed the raw features into a temparal
...
assembled. By converting the raw signal to frequency space, such temparal shift
